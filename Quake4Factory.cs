...
{
    public class Quake4Factory : IComponentFactory
    {
        private Quake4Component _instance;
        ...
        {
            get { return "Automates splitting and load removal for Quake 4."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            return (_instance = new Quake4Component(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.Quake4/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.Quake4.xml"; }
        }
    }
